    ...
    <>
     ...
     <header className="w-full p-4 bg-gradient-radial from-gray-800 to-black  text-center sticky top-2 z-50 flex justify-around items-center  hover:shadow-white hover:shadow-md">
      ...
      <nav className="flex text-blue-400 font-bold">
        <Link href="#about" className="mx-4 hover:text-blue-300 hover:border-b hover:border-t  hover:border-green-500">
          About Me
        </Link>
        <Link href="#projects" className="mx-4 hover:text-blue-300 hover:border-b hover:border-t  hover:border-green-500">
          Projects
        </Link>
        <Link href="#contact" className="mx-4 hover:text-blue-300 hover:border-b hover:border-t  hover:border-green-500">
          Contact
        </Link>
      </nav>
    </header>
